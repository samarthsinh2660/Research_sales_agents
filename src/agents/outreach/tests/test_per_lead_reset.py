...
from agents.outreach.outreach_automation import update_CRM
from agents.outreach.state import GraphState, LeadData
...
def _run_update_crm():
    ...
    with patch("agents.outreach.outreach_automation.get_lead_loader", return_value=_StubLoader()):
