    ...
    fallback_model: str = Field(
        ...
        metadata={
            "x_oap_ui_config": {
                ...
                "description": "Comma-separated backup models, tried in order when the primary is rate-limited or unavailable. A list rather than one name because the free-tier request limit is charged per model: retrying an exhausted model always fails, while the next one down is a fresh quota bucket. Gemma is last because it cannot make tool calls."
            }
        }
    )
